...
Feature: SQL Query Reports
  ...
  Scenario: View an SQL Query report that returns no data
    Given the following SQL Query report exists:
      | name        | Test query                               |
  ...
  @javascript
  Scenario: Create an SQL Query report in a custom category
  ...
  Scenario: Create and run an SQL Query report that has parameters
    When I log in as "admin"
    And I navigate to "Reports > SQL Query Reports" in site administration
    And I press "Add a new query"
    And I set the following fields to these values:
  ...
  Scenario: Link directly to an SQL Query report that has parameters
    Given the following SQL Query report exists:
      | name        | Find user                                       |
  ...
  Scenario: Link directly to an SQL Query report giving some parameters
    Given the following SQL Query report exists:
      | name        | Find user                                                                  |
